    ...
    <div class="corps">
      <div class="grille">
        <div class="entete_grille" id="haut">
          <a href="./Explorer_auto.php" class="txt_entete_grille"><I>Explorer</I></a>
          <p class="txt_entete_grille"><I>Dans le mémoire</I></p>
        </div>
<!-- début du code généré par PHP automatique -->
        <?php
          ...
          $fd = fopen("../img/Data_DansLeMemoire.txt", "r");//ouverture du fichier de données en lecture seul
          $ligne_courante = '';
          $nom_fichier_img = '';
          $dimension_img = '';
          $lieu = '';
          ...
          if (isset($_GET['video']))
          {
            ...
            {
              $data = explode(", ", $donnees['Boukhara_14-01-19_10-30.jpg']['lieu']);

              echo '          ' . $donnees['Boukhara_14-01-19_10-30.jpg']['code_video'] . "\n";
              echo "          </div>\n";
              echo '          <div id="player_legende">' . "\n";
...
//          echo "         </div>\n";
          echo "       </div>\n";
          echo "     </div>\n";
          //$donnees[$position[$i][$i2]]['lieu'] . '<br />' . $donnees[$position[$i][$i2]]['date']
        ?>
  </body>
</HTML>
